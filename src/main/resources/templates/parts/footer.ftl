        ...
        <div class="row mt-3">
            ...
            <div class="col-lg-6">
                ...
                <script type='text/javascript'>function init_map(){
                        var myOptions = {zoom:17,center:new google.maps.LatLng(53.946290, 27.682371 ),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(53.946290, 27.682371 )});infowindow = new google.maps.InfoWindow({content:'<strong>ИП Рыбак, Valtec</strong><br>Беларусь, Гомель, ул. Советская 134/2<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
            ...
            <div class="col-lg-6 footer_contact text-right">
                <p class="contact-name"><b>Матулькин А.Н. Михайловская М Ванский П</b></p>
